...
![Snip of Raw Data in Excel](snip_raw_electronidex_data.png){width=50%}
...
![Snip of Data Transformed into a Sparse Matrix](snip_trandformed_eletronidex_data_num.png){width=50%}
